...
//  Serial.print("Original AZ:"); Serial.print(AZCommandPosition);
...
//  long homecount = AZCommandPosition;
  ...
  Serial.println("Done.");
// Serial.print("Before shortcut:"); Serial.print(AZCommandPosition);

  TakeShortCut(AZCommandPosition);
// Serial.print("After shortcut:"); Serial.print(AZCommandPosition);
